...
class EmployeeMonthlySalaryDataSheet implements WithHeadings, WithMapping, WithEvents, FromArray
{
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                if (!empty($recurring)) {
                    ...
                    // ✅ Column D = salary_component
                    $this->applyDropdown($sheet, 'D2:D500', '=RecList');
                }
            }
        ];
    }
