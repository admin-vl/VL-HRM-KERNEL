...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::middleware('permission:manage-employee-salaries')->group(function () {
            ...
            Route::get('hr/employee-salaries/create_bulk', [\App\Http\Controllers\EmployeeSalaryController::class, 'create_bulk'])->name('hr.employee-salaries.create_bulk');
            Route::get('/hr/employee-salaries/export-sample', [\App\Http\Controllers\EmployeeSalaryController::class, 'downloadTemplate'])->name('hr.employee-salaries.download-template');
            Route::post('hr/employee-salaries/bulk', [\App\Http\Controllers\EmployeeSalaryController::class, 'bulkCreate'])->middleware('permission:create-employee-salaries')->name('hr.employee-salaries.bulkStore');
