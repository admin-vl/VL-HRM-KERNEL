...
export default function EmployeeSalaries() {
      ...
      router.post(route('hr.employee-salaries.store'), formData, {
        ...
        onError: (errors) => {
          ...
          if (typeof errors === 'string') {
            ...
            toast.error(`Failed to create Monthly Salary Settlement: ${Object.values(errors).join(', ')}`);
          }
        }
      });
      ...
      router.put(route('hr.employee-salaries.update', currentItem.id), formData, {
        ...
        onError: (errors) => {
          ...
          if (typeof errors === 'string') {
            ...
            toast.error(`Failed to update Monthly Salary Settlement: ${Object.values(errors).join(', ')}`);
          }
        }
      });
    }
    ...
    router.delete(route('hr.employee-salaries.destroy', currentItem.id), {
      ...
      onError: (errors) => {
        ...
        if (typeof errors === 'string') {
          ...
          toast.error(`Failed to delete Monthly Salary Settlement: ${Object.values(errors).join(', ')}`);
        }
      }
    });
  };
    ...
    router.put(route('hr.employee-salaries.toggle-status', salary.id), {}, {
      ...
      onError: (errors) => {
        ...
        if (typeof errors === 'string') {
          ...
          toast.error(`Failed to update Monthly Salary Settlement status: ${Object.values(errors).join(', ')}`);
        }
      }
    });
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('Monthly Salary Settlements') }
  ];
  ...
  return (
    ...
    >
      ...
      <CrudFormModal
        ...
        title={
          formMode === 'create'
            ? t('Setup Monthly Salary Settlement')
            : formMode === 'edit'
              ? t('Edit Monthly Salary Settlement')
              : t('View Monthly Salary Settlement')
        }
        mode={formMode}
      />
      ...
      <CrudDeleteModal
        ...
        entityName="Monthly Salary Settlement"
      />
    </PageTemplate>
  );
}