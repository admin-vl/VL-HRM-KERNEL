...
export default function ReportSalary() {
  ...
  // const applyFilters = () => {
  //   router.get(route('reports.salary'), {
  //     page: 1,
  ...
  const applyFilters = () => {
    ...
    router.get(route('reports.salary'), params, { preserveState: true, preserveScroll: true });
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('HR Management'), href: route('reports.salary') },
    { title: t('Locations') }
  ];
