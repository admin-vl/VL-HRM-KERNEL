...
export default function ReportNetPay() {
  ...
  // const applyFilters = () => {
  //   router.get(route('reports.netpay'), {
  //     page: 1,
  ...
  const applyFilters = () => {
    ...
    router.get(route('reports.netpay'), params, { preserveState: true, preserveScroll: true });
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('HR Management'), href: route('reports.netpay') },
    { title: t('Locations') }
  ];
