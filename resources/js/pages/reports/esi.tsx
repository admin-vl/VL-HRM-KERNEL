...
export default function ReportEsi() {
  ...
  const applyFilters = () => {
    ...
    router.get(route('reports.esi'), params, { preserveState: true, preserveScroll: true });
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('HR Management'), href: route('reports.esi') },
    { title: t('Locations') }
  ];
  ...
  const columns = [
    ...
    {
      key: 'monthly_wages',
      label: t('Monthly Wages')
    },
    {
      key: 'employee_esi',
      label: t('Employee ESI')
    },
    {
      key: 'reason_code',
      label: t('Reason Code')
