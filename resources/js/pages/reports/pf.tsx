...
export default function ReportPf() {
  ...
  const applyFilters = () => {
    ...
    router.get(route('reports.pf'), params, { preserveState: true, preserveScroll: true });
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('HR Management'), href: route('reports.pf') },
    { title: t('Locations') }
  ];
