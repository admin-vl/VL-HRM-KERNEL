...
export default function ReportLwf() {
  ...
  const applyFilters = () => {
    ...
    router.get(route('reports.lwf'), params, { preserveState: true, preserveScroll: true });
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('HR Management'), href: route('reports.lwf') },
    { title: t('Locations') }
  ];
  ...
  const columns = [
    ...
    {
      key: 'lwf_amount_employee',
      label: t('LWF Amount Employee')
    },
    {
      key: 'lwf_amount_employer',
      label: t('LWF Amount Employer')
    }
  ];
