...
export default function ReportPtax() {
  ...
  const applyFilters = () => {
    ...
    router.get(route('reports.ptax'), params, { preserveState: true, preserveScroll: true });
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('HR Management'), href: route('reports.ptax') },
    { title: t('Locations') }
  ];
