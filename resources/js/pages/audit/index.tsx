...
export default function Audits() {
  ...
  const { auth, users, audits, filters: pageFilters = {} } = usePage().props as any;
  ...
  const applyFilters = () => {
    ...
    router.get(route('audits.index'), params, { preserveState: true, preserveScroll: true });
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('HR Management'), href: route('audits.index') },
    { title: t('Locations') }
  ];
