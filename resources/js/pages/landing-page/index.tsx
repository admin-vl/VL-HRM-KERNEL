  ...
  -------------------------------- */
    useEffect(() => {
        ...
        cssFiles.forEach((href) => {
            ...
            link.onerror = done; // safety fallback
            document.head.appendChild(link);
        });

        // Safety timeout (in case browser skips onload)
...
useEffect(() => {
  ...
  const scripts = [
    ...
    `${base}/assets/js/bxslider.js`,
    `${base}/assets/js/slick-animation.min.js`,
    `${base}/assets/js/jquery.fancybox.js`,
    `${base}/assets/js/wow.js`,
    `${base}/assets/js/appear.js`,
    ...
    `${base}/assets/js/splitting.js`,
    `${base}/assets/js/splitType.js`,
    `${base}/assets/js/script-gsap.js`,
    `${base}/assets/js/select2.min.js`,
    `${base}/assets/js/script.js`, // ✅ MUST BE LAST
  ];
...
useEffect(() => {
  if (!isLoading) {
    setTimeout(() => {
      ...
      // 🔥 Re-run theme init if needed
      // @ts-ignore
      window.themeInit && window.themeInit();
    ...
    return (
        <>
            <div className={`preloader ${isLoading ? 'active' : 'hidden'}`}></div>
            ...
            <div style={{ display: isLoading ? 'none' : 'block' }}>
                        ...
                        <div className="container">
                            <div className="content-box">
                                ...
                                <p className="text wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
                                    Streamline HR operations, automate payroll, track attendance, and manage employees effortlessly from a single
                                    platform.
                                </p>
                                    ...
                                    <div className="inner-column">
                                        <div className="sec-title mb-30">
                                            ...
                                            <p className="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                                We are dedicated to helping businesses streamline HR operations and empower employees with smart HR
                                        ...
                                        <div className="content-box" style={{ fontSize: '14px', lineHeight: '1.8' }}>
                                            <div className="item wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                                ...
                                                <p className="text">
                                                    Redefine HR management by providing simple, scalable, and intelligent solutions that save time and
                                                    boost productivity.
                                                </p>
                                            </div>
                                            ...
                                            <div className="item wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                                                <h4 className="sub-title mb-2" style={{ marginTop: '15px' }}>
                                                    <i className="fa-solid fa-check" style={{ color: '#1A4137', marginRight: '8px' }}></i>Our
                                                    Commitment
                                                </h4>
                                                <p className="text">
                                ...
                                <div className="col-lg-6 content-column">
                                    <div className="inner-column">
                                        <div className="sec-title mb-30">
                                            ...
                                            <p className="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                                Please read these terms carefully before using our VL HRM platform. By accessing or using our
                                        ...
                                        <div className="acc" id="customAccordion">
                                            ...
                                            <div className="acc-item active">
                                                ...
                                                <div className="acc-collapse show">
                                                    <div className="acc-body">
                                                        <p className="text">
                                                            By creating an account or using our VL HRM product, you confirm that you have read,
                                                            understood, and agree to be bound by these Terms of Service. If you do not agree, you may
                                            ...
                                            <div className="acc-item">
                                                ...
                                                <div className="acc-collapse" style={{ display: 'none' }}>
                                                    <div className="acc-body">
                                                        <p className="text">
                                                            Our platform provides businesses with Human Resource Management solutions, including but
                                                            not limited to employee records, attendance tracking, payroll management, performance
                                                            evaluations, and comprehensive analytics.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="acc-item">
                                                ...
                                                <div className="acc-collapse" style={{ display: 'none' }}>
                                                    <div className="acc-body">
                                                        <p className="text">
                                                            You agree to provide accurate information, maintain login confidentiality, ensure uploaded
                                                            content complies with applicable laws, and use the platform only for lawful HR management
                                                            purposes.
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="acc-item">
                                                ...
                                                <div className="acc-collapse" style={{ display: 'none' }}>
                                                    <div className="acc-body">
                                                        <p className="text">
                                                            Your data is handled according to our Privacy Policy. You are responsible for safeguarding
                                                            your account access.
                                                        </p>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="swiper testimonial-slider-four">
                                        <div className="swiper-wrapper">
                                            <div className="swiper-slide">
                                              <h2>Testimonials</h2>
                                                <p className="text">
                                                    Ascend the mountain not to plant your flag, but to embrace the challenge, savour the journey, and
                                                    marvel at the view. Climb to experience the world, not for the world to notice you. This is why
                                                    they stand out with exceptional
                                                </p>
                                            </div>
                                            <div className="swiper-slide">
                                               <h2>Testimonials</h2>
                                    ...
                                    <div className="accordion" id="faqAccordion">
                                        <div className="accordion-item wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                            ...
                                            <div id="faq1" className="accordion-collapse show collapse" data-bs-parent="#faqAccordion">
                                                <div className="accordion-body">
                                                    Our VL HRM is an all-in-one platform designed to manage your employees, payroll, attendance,
                                                    performance, and leave. It simplifies HR operations and helps businesses run efficiently with
                                                    comprehensive tools for managing all aspects of human resources.
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="accordion-item wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                            ...
                                            <div id="faq3" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                                <div className="accordion-body">
                                                    We offer multiple subscription plans including Basic, Professional, and Enterprise options. Each
                                                    plan is tailored for businesses of all sizes with features designed to meet different
                                                    organizational needs and growth stages.
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="accordion-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                                            ...
                                            <div id="faq4" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                                <div className="accordion-body">
                                                    Absolutely! You can customize workflows for attendance tracking, leave approvals, performance
                                                    reviews, and payroll according to your company policies. Our platform is flexible and adapts to
                                        ...
                                        <div className="accordion-item wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                            ...
                                            <div id="faq5" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                                <div className="accordion-body">
                                                    Our analytics dashboard provides real-time insights on employee attendance, payroll reports,
                                                    performance trends, and leave balances. These comprehensive metrics help you make informed HR
                                                    decisions and optimize your workforce management strategies.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <section id="contacts" className="contact-section-four">
                        <div className="container">
                            <div className="outer-box">
                                <div className="sec-title center mb-50">
                                    ...
                                    <p className="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                        By submitting this form you are agrecing to our Privacy Policy, <br /> We guarantee not to disclose your
                                        information.
                                    </p>
                                </div>
                        ...
                        <div className="google-map">
                           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3152.5740551226704!2d144.96202317546206!3d-37.80002083325193!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642d39f314a09%3A0x516d87a4e6e86d30!2s700%20Swanston%20St%2C%20Carlton%20VIC%203053%2C%20Australia!5e0!3m2!1sen!2sin!4v1766850897324!5m2!1sen!2sin" width="600" height="450" style={{border:0}}  loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </section>
