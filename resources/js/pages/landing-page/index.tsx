...
React.useEffect(() => {
  ...
  <div className="main-box">
    <div className="mobile-nav-toggler"><i className="icon lnr-icon-bars"></i>Menu</div>
    <div className="logo-box">
      <div className="logo">
                <a href="/" title=""><img src="assets/logos/vl_logo.svg" alt="" title="VL HRM"/></a>
      </div>
    </div>
    {/* <!--Nav Box--> */}
    ...
    <div className="outer-box">
      <div className="info-box">
        ...
        <a className="btn-one" href={route('login')}>Login</a>
      </div>
      {/* <!-- Mobile Nav toggler --> */}
    </div>
  </div>
    ...
    <div className="mobile-menu">
      ...
      <nav className="menu-box">
        <div className="upper-box">
          <div className="nav-logo"><a href="index-2.html"><img src="assets/logos/vl_logo.svg" alt=""/></a></div>
    ...
    <div className="sticky-header">
      <div className="auto-container">
        <div className="inner-container">
          {/* <!--Logo--> */}
          <div className="logo">
                        <a href="/" title=""><img src="assets/logos/VL - dark.svg" alt="" title="VL HRM"/></a>
          </div>
          {/* <!--Right Col--> */}
          <div className="nav-outer">
            {/* <!-- Main Menu --> */}
...
<section id="home" className="banner-section-four">
    ...
    <div className="content-box">
        <h5 className="title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms"> All-in-One HRM Solution for a<br/><span>Productive Workforce</span></h5>
        <p className="text wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">Streamline HR operations, automate payroll, track attendance, and manage employees effortlessly from a single platform.</p>
        <div className="btn-wrp">
        <a className="btn-one-rounded wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms" href={route('register')}>Get Started</a>
        <h6 className="btn-title wow fadeInUp" data-wow-delay="700ms" data-wow-duration="1500ms"><a href="https://www.youtube.com/watch?v=Lplq8RjQ0zU" data-fancybox="gallery" data-caption="" className="video-btn"><i className="fa-sharp fa-solid fa-play"></i></a>Watch Video</h6>
        </div>
    </div>
    </div>
</section>
    ...
    <div className="image-box">
        ...
        <div className="swiper-wrapper">
            ...
            <figure className="image">
                <img src="assets/images/banner/banner-four-image.jpg" alt="Image"/>
            </figure>
            </div>
            <div className="swiper-slide">
            <figure className="image">
            ...
            <div className="swiper-slide">
            <figure className="image">
                <img src="assets/images/banner/banner-four-image3.jpg" alt="Image"/>
            </figure>
            </div>
        </div>
        </div>
    ...
    <div className="outer-box">
        ...
        <div className="swiper-wrapper">
            ...
            <div className="brand-block">
                <a href="#"><img src="assets/images/brand/brand-two-image1.png" alt="Image"/></a>
            </div>
            </div>
            <div className="swiper-slide">
            <div className="brand-block">
                <a href="#"><img src="assets/images/brand/brand-two-image2.png" alt="Image"/></a>
            </div>
            </div>
            <div className="swiper-slide">
            <div className="brand-block">
                <a href="#"><img src="assets/images/brand/brand-two-image3.png" alt="Image"/></a>
            </div>
            </div>
            <div className="swiper-slide">
            <div className="brand-block">
                <a href="#"><img src="assets/images/brand/brand-two-image4.png" alt="Image"/></a>
            </div>
            </div>
            <div className="swiper-slide">
            <div className="brand-block">
                <a href="#"><img src="assets/images/brand/brand-two-image5.png" alt="Image"/></a>
            </div>
            </div>
            <div className="swiper-slide">
            <div className="brand-block">
...
<section id="about" className="about-section-four pt-120 pb-120 paralax__animation">
    ...
    <div className="row g-5">
        ...
        <div className="inner-column">
            ...
            <h2 className="title">5<span><span>+ </span> Years Experience</span></h2>
            <div className="users">
        ...
        <div className="inner-column">
            ...
            <h2 className="title wow splt-txt" data-splitting>VL HRM Solution: Transforming Workforce Management</h2>
            <p className="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">We are dedicated to helping businesses streamline HR operations and empower employees with smart HR software that makes a difference.</p>
            </div>
            ...
            <div className="item wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                <h4 className="sub-title mb-2"><i className="fa-solid fa-check" style={{ color: "#1A4137", marginRight: "8px" }}></i>Our Mission</h4>
                <p className="text">Redefine HR management by providing simple, scalable, and intelligent solutions that save time and boost productivity.</p>
            </div>
            <div className="item wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                <h4 className="sub-title mb-2" style={{ marginTop: "15px" }}><i className="fa-solid fa-check" style={{ color: "#1A4137", marginRight: "8px" }}></i>Our Values</h4>
                <p className="text">Innovation, integrity, and inclusivity ensure businesses and employees thrive together.</p>
            </div>
            <div className="item wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <h4 className="sub-title mb-2" style={{ marginTop: "15px" }}><i className="fa-solid fa-check" style={{ color: "#1A4137", marginRight: "8px" }}></i>Our Commitment</h4>
                <p className="text">Deliver secure, scalable, and user-friendly HR solutions with outstanding customer support.</p>
            </div>
            </div>
        </div>
        </div>
...
<section id="service" className="service-section-four pt-120 pb-120">
    ...
    <div className="row g-5">
        ...
        <div className="inner-column">
            <div className="sec-title mb-30">
            <h6 className="sub-title wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Terms of Service</h6>
            <h2 className="title wow splt-txt" data-splitting>VL HRM Platform Terms & Conditions</h2>
            <p className="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Please read these terms carefully before using our VL HRM platform. By accessing or using our services, you agree to these terms.</p>
            </div>
            <div className="info">
        ...
        <div className="service-block-four">
            ...
            <div className="acc-item active">
                ...
                <div className="acc-body">
                    <p className="text">By creating an account or using our VL HRM product, you confirm that you have read, understood, and agree to be bound by these Terms of Service. If you do not agree, you may not use the platform.</p>
                </div>
                </div>
            </div>
            ...
            <div className="acc-item">
                ...
                <div className="acc-body">
                    <p className="text">Our platform provides businesses with Human Resource Management solutions, including but not limited to employee records, attendance tracking, payroll management, performance evaluations, and comprehensive analytics.</p>
                </div>
                </div>
            </div>
            ...
            <div className="acc-item">
                ...
                <div className="acc-collapse" style={{ display: "none" }}>
                <div className="acc-body">
                    <p className="text">You agree to provide accurate information, maintain login confidentiality, ensure uploaded content complies with applicable laws, and use the platform only for lawful HR management purposes.</p>
                </div>
                </div>
            </div>
            ...
            <div className="acc-item">
                ...
                <div className="acc-collapse" style={{ display: "none" }}>
                <div className="acc-body">
                    <p className="text">Your data is handled according to our Privacy Policy. You are responsible for safeguarding your account access.</p>
                </div>
                </div>
            </div>
        </div>
...
<section id="news" className="blog-section-four pt-40 have-padding">
    <div className="sec-shape">
    <img src="assets/images/shape/blog-four-shape.png" alt="Image"/>
    </div>
    <div className="container">
    <div className="sec-title mb-50">
        <h6 className="sub-title wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">FAQ</h6>
        <div className="flex-content">
        <h2 className="title wow splt-txt" data-splitting>Frequently Asked Questions</h2>
            <p className="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Get quick answers to the most common queries about using our VL HRM platform.</p>
        </div>
    </div>
            ...
            <div className="accordion" id="faqAccordion">
                <div className="accordion-item wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                    ...
                    <div id="faq1" className="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                        <div className="accordion-body">
                            Our VL HRM is an all-in-one platform designed to manage your employees, payroll, attendance, performance, and leave. It simplifies HR operations and helps businesses run efficiently with comprehensive tools for managing all aspects of human resources.
                        </div>
                    </div>
                </div>
                    ...
                    <div id="faq2" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div className="accordion-body">
                            ...
                            <ul className="faq-list">
                                <li><i className="fa-solid fa-check"></i> Sign up for an VL HRM account</li>
                                <li><i className="fa-solid fa-check"></i> Set up your company profile and departments</li>
                                <li><i className="fa-solid fa-check"></i> Add employees and assign roles</li>
                                <li><i className="fa-solid fa-check"></i> Configure payroll, attendance, and leave policies</li>
                                <li><i className="fa-solid fa-check"></i> Start managing HR processes efficiently</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    ...
                    <div id="faq3" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div className="accordion-body">
                            We offer multiple subscription plans including Basic, Professional, and Enterprise options. Each plan is tailored for businesses of all sizes with features designed to meet different organizational needs and growth stages.
                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                    ...
                    <div id="faq4" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div className="accordion-body">
                            Absolutely! You can customize workflows for attendance tracking, leave approvals, performance reviews, and payroll according to your company policies. Our platform is flexible and adapts to your unique business requirements.
                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    ...
                    <div id="faq5" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                        <div className="accordion-body">
                            Our analytics dashboard provides real-time insights on employee attendance, payroll reports, performance trends, and leave balances. These comprehensive metrics help you make informed HR decisions and optimize your workforce management strategies.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div className="row mt-50">
        <div className="col-lg-12 text-center">
            <p className="text wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Still have questions? <a href="page-contact.html" className="link-color">Contact our support team</a> for additional assistance.</p>
        </div>
    </div>
    </div>
</section><section id="contacts" className="contact-section-four">
    <div className="container">
    <div className="outer-box">
        <div className="sec-title center mb-50">
        <h6 className="sub-title wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Get in touch</h6>
        <h2 className="title wow splt-txt" data-splitting>Book An Appointment</h2>
        <p className="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">By submitting this form you are agrecing to our Privacy Policy, <br/> We guarantee not to disclose your information.</p>
        </div>
        <div className="contact-block-four">
        <form id="contact_form" name="contact_form" action="https://php.kodesolution.com/2025/consultez-php/includes/sendmail.php" method="post">
            <div className="row g-4">
            ...
            <div className="col-lg-12">
                ...
                <button className="btn-one mt-4 mx-auto" data-animation="fadeInUp" data-delay=".8s">free consultation <i className="fa-solid fa-angle-right ms-2"></i></button>
                </div>
            </div>
            </div>
        </form>
 ...
 <footer className="main-footer footer-style-four">
    <div className="container">
        ...
        <div className="row g-5 justify-content-between">
          <div className="col-sm-12 col-lg-5 col-xl-6">
            <div className="footer-widget about-widget">
              ...
              <div className="input-feild">
                ...
                <a className="btn-one-rounded" href="#0">Sign Up <i className="fa-regular fa-angle-right"></i></a>
              </div>
              <h5 className="privacy">By subscribing, you’re accept <a href="page-policy.html">Privacy Policy</a></h5>
            </div>
          </div>
            ...
            <div className="footer-widget links-widget">
              ...
              <div className="widget-content">
                <ul className="user-links">
                  ...
                  <li><a href="#testimonial">Refund Policy</a></li>
                  <li><a href="#news">FAQ</a></li>
          ...
          <div className="col-sm-6 col-lg-4 col-xl-3">
            <div className="footer-widget contact-widget">
              ...
              <div className="widget-content">
                <a href="mailto:hello@vedalogic.com.au">hello@vedalogic.com.au</a>
                <h4 className="nuber"><a href="tel:+61 406817182">+61 406817182</a></h4>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="footer-bottom">
        <div className="logo">
          <a href="/"><img src="assets/logos/vl_logo.svg" alt="Logo"/></a>
        </div>
        ...
        <p className="copyright-text">© 2025 <a href="#0">VL HRM</a> - IT Services. All rights reserved.</p>
      </div>
    </div>
